      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            {...POPOVER}
            className={cn(
              "border-line bg-paper absolute top-full left-0 z-30 mt-1.5 w-[300px] rounded-lg border p-1 shadow-xl",
              POPOVER_ORIGIN,
            )}
          >
            {isCustom && (
                ...
                <div key={id}>
                  ...
                  >
                    <span className="flex items-center justify-between gap-2">
                      ...
                      {current && (
                        <Check size={12} weight="bold" className="text-ash shrink-0" />
                      )}
                    </span>
                    {/*
